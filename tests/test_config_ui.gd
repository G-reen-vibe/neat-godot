...
func _test_config_apply_roundtrip() -> void:
				...
				_assert(app._config.generation_method == "mixed", "generation_method should be mixed")
				_assert(app._config.crossover_rate == 0.75, "crossover_rate should be 0.75")
				_assert(app._config.interspecies_rate == 0.01, "interspecies_rate should be 0.01")
